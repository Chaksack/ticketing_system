...
import { h } from 'vue'
import { LEAD_STAGE_PROBABILITY } from '~/types/lead'
...
export const leadStages = [
  {
    ...
    probability: LEAD_STAGE_PROBABILITY.new,
  },
  {
    value: 'contacted',
    label: 'Contacted',
    ...
    probability: LEAD_STAGE_PROBABILITY.contacted,
  },
  {
    value: 'qualified',
    label: 'Qualified',
    ...
    probability: LEAD_STAGE_PROBABILITY.qualified,
  },
  {
    value: 'proposal',
    ...
    probability: LEAD_STAGE_PROBABILITY.proposal,
  },
  {
    value: 'won',
    label: 'Won',
    ...
    probability: LEAD_STAGE_PROBABILITY.won,
  },
  {
    value: 'lost',
    label: 'Lost',
    ...
    probability: LEAD_STAGE_PROBABILITY.lost,
  },
]
